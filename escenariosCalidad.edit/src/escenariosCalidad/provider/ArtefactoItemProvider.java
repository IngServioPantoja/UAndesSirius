...
/**
 * This is the item provider adapter for a {@link escenariosCalidad.Artefacto} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArtefactoItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Artefacto_url_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Artefacto_url_feature", "_UI_Artefacto_type"),
				 EscenariosCalidadPackage.Literals.ARTEFACTO__URL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Artefacto)object).getUrl();
		return label == null || label.length() == 0 ?
			getString("_UI_Artefacto_type") :
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Artefacto.class)) {
			case EscenariosCalidadPackage.ARTEFACTO__URL:
