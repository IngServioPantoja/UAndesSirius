		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PetriNet_elements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PetriNet_elements_feature", "_UI_PetriNet_type"),
				 PetrinetPackage.Literals.PETRI_NET__ELEMENTS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PetrinetPackage.Literals.PETRI_NET__ELEMENTS,
				 PetrinetFactory.eINSTANCE.createOutputArc()));

		newChildDescriptors.add
			(createChildParameter
				(PetrinetPackage.Literals.PETRI_NET__ELEMENTS,
				 PetrinetFactory.eINSTANCE.createInputArc()));
